...
- *2026.08* Released [DME Technical Report](https://arxiv.org/abs/2608.02148), an efficient and powerful MLLM embedding model that achieves SOTA performance on the [MMEBv2](https://huggingface.co/spaces/TIGER-Lab/MMEB-Leaderboard) leaderboard. See also our [Tech Blog](https://mp.weixin.qq.com/s/7uiU7PViWK3G7stmX1f_Kw).
...
[[WeChat]](https://mp.weixin.qq.com/s/7uiU7PViWK3G7stmX1f_Kw)
</div>
</div>
